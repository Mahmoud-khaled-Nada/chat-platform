...
interface Props {
  ...
  setShowModalUserProfile: React.Dispatch<React.SetStateAction<boolean>>;
}

const ModalUserProfile: FC<Props> = ({
  showModalUserProfile,
  setShowModalUserProfile,
}) => {
  return (
    <div
      className={`modal fade ${showModalUserProfile ? "show is-display" : ""}`}
              ...
              <div className="profile-img text-primary rounded-top-xl">
                ...
                <div className="position-absolute top-0 start-0 p-5">
                  <button
                    ...
                    onClick={() => setShowModalUserProfile(false)}
                  ></button>
                </div>
              </div>
