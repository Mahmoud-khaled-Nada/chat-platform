...
interface Props {
  ...
  setShowModalProfile: React.Dispatch<React.SetStateAction<boolean>>;
}

const ModalProfile: FC<Props> = ({ showModalProfile, setShowModalProfile }) => {




  return (
    <div className={`modal fade ${showModalProfile ? "show is-display" : ""}`}>
